<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div>
                <a href="{{ route('campos.edit', $campo) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
                    Editar
                </a>
                <a href="{{ route('campos.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                    Volver
                </a>
            </div>
        </div>
