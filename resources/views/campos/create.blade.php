                    ...
                    <form method="POST" action="{{ route('campos.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="numero_hoyos" id="numero_hoyos"
                                   ...
                                   value="{{ old('numero_hoyos') }}" required min="1">
                            @error('numero_hoyos')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="tipo" id="tipo"
                                ...
                                <option value="público" {{ old('tipo') == 'público' ? 'selected' : '' }}>Público</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="tarifa" id="tarifa" step="0.01"
                                   ...
                                   value="{{ old('tarifa') }}" required min="0">
                            @error('tarifa')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
