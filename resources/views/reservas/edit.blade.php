                    ...
                    <form method="POST" action="{{ route('reservas.update', $reserva) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="hora_inicio" id="hora_inicio"
                                   ...
                                   value="{{ old('hora_inicio', substr($reserva->hora_inicio, 0, 5)) }}" required>
                            @error('hora_inicio')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="duracion" id="duracion"
                                   ...
                                   value="{{ old('duracion', $reserva->duracion) }}" required min="30" step="30">
                            @error('duracion')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="numero_jugadores" id="numero_jugadores"
                                   ...
                                   value="{{ old('numero_jugadores', $reserva->numero_jugadores) }}" required min="1" max="4">
